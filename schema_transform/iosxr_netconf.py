...
from schema_transform.base_schema_transform import SchemaTransformBase

class IosxrSchemaTransform(SchemaTransformBase):
    def __init__(self):
    ...
    def openconfig_to_netconf(self, config):
        config_xml = super(IosxrSchemaTransform, self).openconfig_to_netconf(config)
